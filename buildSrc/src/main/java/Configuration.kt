...
object Configuration {
    ...
    object SigningConfigs {
        ...
        /** 密钥别名 */
        const val key_alias = "saint"

        /** 别名密码 */
        const val key_password = "12345678"

        /** 密钥文件路径 */
        const val store_file = "saint_key.jks"

        /** 密钥密码 */
        const val store_password = "12345678"
    }
    ...
    object AppConfigs {
        ...
        /** 应用 id */
        const val application_id = "com.saint.struct"
...
//    const val paging_version = "2.1.2"
    ...
    object Dependencies {
        ...
        /** androidx 约束性布局 */
        const val androidx_constraint = "androidx.constraintlayout:constraintlayout:2.1.3"
         ...
         * volley
         */
        const val volley = "com.android.volley:volley:${Versions.volley_version}"
         ...
         * rxjava2
         */
        const val rxjava = "io.reactivex.rxjava2:rxjava:${Versions.rxjava2_version}"
