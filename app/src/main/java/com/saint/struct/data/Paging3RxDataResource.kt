...
class Paging3RxDataResource(private val mService: ConnectService) : RxPagingSource<Int, WanListBean>() {
    ...
    companion object {
        private val TAG = Paging3RxDataResource::class.java.simpleName
    }
}